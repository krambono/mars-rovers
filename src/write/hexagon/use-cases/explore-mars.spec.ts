import { FakeIdGenerator } from 'src/write/adapters/secondary/fake-id-generator';
import { FakeMissionReportHandler } from 'src/write/adapters/secondary/fake-mission-report-handler';
